...
Scene* MenuPick_3::createScene()
{
	return MenuPick_3::create();
}

bool MenuPick_3::init()
{
	if (!Scene::init())
	{
		return false;
	...
	//还是加了个计时器
	this->schedule(CC_SCHEDULE_SELECTOR(MenuPick_3::pickdifficulty));
	...
	auto Main_interface = Sprite::create("Cover/Spring Shadow -MyGo.png");
	...
	auto MenuPick1 = MenuItemSprite::create(White1, White1,
		CC_CALLBACK_0(MenuPick_3::pickmusic, this, 1));
	//曲名加到精灵上
	auto Pick1 = Label::createWithTTF(FontToUTF8("希望の花"), "fonts/simhei.ttf", 36);
	...
	auto MenuPick2 = MenuItemSprite::create(White2, White2,
		CC_CALLBACK_0(MenuPick_3::pickmusic, this, 2));
	auto Pick2 = Label::createWithTTF(FontToUTF8("春日影"), "fonts/simhei.ttf", 36);
	...
	auto MenuPick3 = MenuItemSprite::create(White3, White3,
		CC_CALLBACK_0(MenuPick_3::pickmusic, this, 3));
	auto Pick3 = Label::createWithTTF("For the Damaged Coda", "fonts/arial.ttf", 36);
	...
	auto MenuPick4 = MenuItemSprite::create(White4, White4,
		CC_CALLBACK_0(MenuPick_3::pickmusic, this, 4));
	auto Pick4 = Label::createWithTTF("Bad Apple", "fonts/arial.ttf", 36);
	...
	auto MenuPick5 = MenuItemSprite::create(White5, White5,
		CC_CALLBACK_0(MenuPick_3::pickmusic, this, 5));
	auto Pick5 = Label::createWithTTF(FontToUTF8("某科学の超电磁炮"), "fonts/simhei.ttf", 36);
	...
	auto MenuPick6 = MenuItemSprite::create(White6, White6,
		CC_CALLBACK_0(MenuPick_3::pickmusic, this, 6));
	auto Pick6 = Label::createWithTTF("Number One", "fonts/arial.ttf", 36);
	...
	auto Ez_Diff = MenuItemImage::create("Cover/Ez1.png", "Cover/Ez1.png",
		CC_CALLBACK_0(MenuPick_3::pickdiffprer, this, 1));
	auto Hd_Diff = MenuItemImage::create("Cover/Hd1.png", "Cover/Hd1.png",
		CC_CALLBACK_0(MenuPick_3::pickdiffprer, this, 2));
	auto In_Diff = MenuItemImage::create("Cover/In1.png", "Cover/In1.png",
		CC_CALLBACK_0(MenuPick_3::pickdiffprer, this, 3));
...
songContainer->addChild(Pick_Arrow, 2, 8);
	...
	auto Enter = MenuItemImage::create("Cover/Enter.png", "Cover/Enter2.png", "Cover/Enter.png",
		CC_CALLBACK_1(MenuPick_3::gameplay, this));
...
void MenuPick_3::pickmusic(int pick)
{
	auto visibleSize = Director::getInstance()->getVisibleSize();
	...
	if (pick == 1)
	{
		music_name = "Kibonoha -Uru";
		pickarrow->setPosition(Vec2(515, 900));
	}
	else if (pick == 2)
	{
		music_name = "Spring Shadow -MyGo";
		pickarrow->setPosition(Vec2(515, 800));
	}
	else if (pick == 3)
	{
		music_name = "For the Damaged Coda -Rick and Morty";
		pickarrow->setPosition(Vec2(515, 700));
	}
	else if (pick == 4)
	{
		music_name = "Bad Apple -TouHou";
		pickarrow->setPosition(Vec2(515, 600));
	}
	else if (pick == 5)
	{
		music_name = "Only My Railgun -Super Gun";
		pickarrow->setPosition(Vec2(515, 500));
	}
	else if (pick == 6)
	{
		music_name = "Number One -Bleach";
...
void MenuPick_3::pickspeed(int pick)
{
...
void MenuPick_3::pickdiffprer(int pick)
{
	Pick_diff = pick;
...
//更新
void MenuPick_3::pickdifficulty(float dt)
{
...
void MenuPick_3::backmeun()
{
	Director::getInstance()->popScene();
}

char* MenuPick_3::FontToUTF8(const char* font)
{
...
void MenuPick_3::gameplay(Ref* pSender)
{
	Filename = music_name;
	if (Pick_diff == 1)
	{
...
void MenuPick_3::restartplay(Ref* pSender)
{
	PLay_Back = 0;
	Filename = music_name;
	if (Pick_diff == 1)
